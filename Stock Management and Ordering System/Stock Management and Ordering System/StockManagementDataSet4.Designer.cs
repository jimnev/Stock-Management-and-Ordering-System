...
namespace Stock_Management_and_Ordering_System {
    ...
    public partial class StockManagementDataSet4 : global::System.Data.DataSet {
        ...
        public partial class productsDataTable : global::System.Data.TypedTableBase<productsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public productsRow AddproductsRow(string name, int quantity, double price, string category, int orderSize, int maxStock) {
...
namespace Stock_Management_and_Ordering_System.StockManagementDataSet4TableAdapters {
    ...
    public partial class productsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [products] WHERE (([name] = @Original_name) AND ([quantity] = @Origin" +
                ...
                "y) AND ([orderSize] = @Original_orderSize) AND ([maxStock] = @Original_maxStock)" +
                ")";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [products] ([name], [quantity], [price], [category], [orderSize], [ma" +
                "xStock]) VALUES (@name, @quantity, @price, @category, @orderSize, @maxStock);\r\nS" +
                "ELECT name, quantity, price, category, orderSize, maxStock FROM products WHERE (" +
                "name = @name)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [products] SET [name] = @name, [quantity] = @quantity, [price] = @price, [category] = @category, [orderSize] = @orderSize, [maxStock] = @maxStock WHERE (([name] = @Original_name) AND ([quantity] = @Original_quantity) AND ([price] = @Original_price) AND ([category] = @Original_category) AND ([orderSize] = @Original_orderSize) AND ([maxStock] = @Original_maxStock));
SELECT name, quantity, price, category, orderSize, maxStock FROM products WHERE (name = @name)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        name, quantity, price, category, orderSize, maxStock\r\nFROM         " +
                "   products";
            ...
            this._commandCollection[3].CommandText = "SELECT        name, quantity, price, category, orderSize, maxStock\r\nFROM         " +
        ...
        public virtual int GetBakery2(StockManagementDataSet4.productsDataTable dataTable) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int GetButchers2(StockManagementDataSet4.productsDataTable dataTable) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int GetButchersOrder(StockManagementDataSet4.productsDataTable dataTable) {
        ...
        public virtual int Delete(string Original_name, int Original_quantity, double Original_price, string Original_category, int Original_orderSize, int Original_maxStock) {
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((int)(Original_orderSize));
            this.Adapter.DeleteCommand.Parameters[5].Value = ((int)(Original_maxStock));
        ...
        public virtual int Insert(string name, int quantity, double price, string category, int orderSize, int maxStock) {
            if ((name == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[4].Value = ((int)(orderSize));
            this.Adapter.InsertCommand.Parameters[5].Value = ((int)(maxStock));
        ...
        public virtual int Update(string name, int quantity, double price, string category, int orderSize, int maxStock, string Original_name, int Original_quantity, double Original_price, string Original_category, int Original_orderSize, int Original_maxStock) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(orderSize));
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(maxStock));
            if ((Original_name == null)) {
                throw new global::System.ArgumentNullException("Original_name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_orderSize));
            this.Adapter.UpdateCommand.Parameters[11].Value = ((int)(Original_maxStock));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int quantity, double price, string category, int orderSize, int maxStock, string Original_name, int Original_quantity, double Original_price, string Original_category, int Original_orderSize, int Original_maxStock) {
            return this.Update(Original_name, quantity, price, category, orderSize, maxStock, Original_name, Original_quantity, Original_price, Original_category, Original_orderSize, Original_maxStock);
        }
    }
